...
const TOPIC_FILES: TopicFile[] = [
  ...
  require('../../content/vhf/nodanrop-mayday.json'),
  require('../../content/vhf/il-och-sakerhetsanrop.json'),
  require('../../content/vhf/fonetiska-alfabetet.json'),
  require('../../content/vhf/gmdss-sjoomraden.json'),
  require('../../content/vhf/radiodisciplin.json'),
  ...
  require('../../content/radar/arpa.json'),
  require('../../content/radar/radar-och-kollisionsundvikande.json'),
